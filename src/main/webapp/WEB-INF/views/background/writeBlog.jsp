        ...
        <div class="layui-form-item layui-form-text">
            ...
            <div class="layui-input-block">
                ...
                <div class="layui-input-block">
                    ...
                    window.open('${pageContext.request.contextPath}/admin/tag/getAlltag','_blank','width=300,height=480,toolbars=yes,resizable=yes,scrollbars=yes,left='+leftVal+',top='+topVal);return false;" href="javascript:void(0);">插入已有标签</a>
                    </div>
                    </div>
                    ...
                    <script type="text/javascript" charset="utf-8">
                        ...
                        layui.use(['upload','layer','form'], function() {
                            ...
                            form.on('submit(formsub)', function(data) {
                                ...
                                $.post({
                                    url: '${pageContext.request.contextPath}/admin/artical/add',
                                    dataType:'json',
                                    contentType: "application/json; charset=utf-8",
