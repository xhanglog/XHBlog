...
<div class="x-body">
    ...
    <xblock>
        <button class="layui-btn" onclick="x_admin_show('添加标签','${pageContext.request.contextPath}/admin/tag_add_edit.html',600,400)"><i class="layui-icon"></i>添加</button>
...
<script>
    layui.use(['table','util'], function(){
        ...
        table.render({
            elem: '#I_am_a_table'
            ,id: 'I_am_a_table'
            ,url:'${pageContext.request.contextPath}/admin/tag/getTags'
            ,method: 'post'
            ,cellMinWidth: 80
            ,cols: [[
                ...
                ,{field:'tagCreateTime', title:'创建时间',width:180,templet:function(d){return util.toDateString(d.tagCreateTime, "yyyy-MM-dd HH:mm:ss");}}
        ...
        table.on('tool(I_am_a_table)', function(obj){
            ...
            if(obj.event === 'del'){
                layer.confirm('要删除吗'+data.tagId, function(res){
                    $.ajax({
                        url: "${pageContext.request.contextPath}/admin/tag/delTagById",
                        type: "POST",
                ...
                x_admin_show('编辑','${pageContext.request.contextPath}/admin/tag/getTagInfo?tagId='+data.tagId,600,400);
            }
        });
    });
</script>
