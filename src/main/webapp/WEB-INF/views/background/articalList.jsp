...
<script>
    layui.use(['table','util'], function(){
        ...
        table.render({
            elem: '#I_am_a_table'
            ,id: 'I_am_a_table'
            ,url:'${pageContext.request.contextPath}/admin/artical/getArticals'
            ,method: 'post'
            ,cellMinWidth: 80
            ,cols: [[
        ...
        form.on('switch(comment)', function(obj){
            ...
            $.ajax({
                type: 'POST'
                ,url:"${pageContext.request.contextPath}/admin/artical/editSwitch"
        ...
        table.on('tool(I_am_a_table)', function(obj){
            ...
            if(obj.event === 'del'){
                layer.confirm('要删除吗'+data.articalId, function(index){
                    $.ajax({
                        url: "${pageContext.request.contextPath}/admin/artical/delArticalById",
                        type: "POST",
                ...
                x_admin_show('编辑','${pageContext.request.contextPath}/admin/artical/getArticalInfo?id='+data.articalId,600,400);
            }
        });
    });
</script>
