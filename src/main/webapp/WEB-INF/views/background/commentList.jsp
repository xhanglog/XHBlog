...
<script>
    layui.use(['table','util'], function(){
        ...
        table.render({
            elem: '#I_am_a_table'
            ,id: 'I_am_a_table'
            ,url:'${pageContext.request.contextPath}/admin/comment/getComments'
            ,method: 'post'
            ,cellMinWidth: 80
            ,cols: [[
        ...
        form.on('switch(commentStatus)', function(obj){
            ...
            $.ajax({
                type: 'POST'
                ,url:"${pageContext.request.contextPath}/admin/comment/editSwitch"
        ...
        table.on('tool(I_am_a_table)', function(obj){
            ...
            if(obj.event === 'del'){
                layer.confirm('要删除吗'+data.commentId, function(index){
                    $.ajax({
                        url: "${pageContext.request.contextPath}/admin/comment/delCommentById",
                        type: "POST",
