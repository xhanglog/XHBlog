...
<head>
    ...
    <script src="${pageContext.request.contextPath}/static/background/lib/layui/layui.js" charset="utf-8"></script>
    ...
    <div class="layui-tab tab" lay-filter="xbs_tab" lay-allowclose="false">
        ...
        <div class="layui-tab-content">
            <div class="layui-tab-item layui-show">
                <iframe src='${pageContext.request.contextPath}/background/welcome.jsp' frameborder="0" scrolling="yes" class="x-iframe"></iframe>
            </div>
        </div>
    </div>
</div>
...
<!-- 底部开始 -->
<div class="footer" >
    <div class="copyright">Copyright ©贰月小巷</div>
</div>
<!-- 底部结束 -->
</body>
</html>